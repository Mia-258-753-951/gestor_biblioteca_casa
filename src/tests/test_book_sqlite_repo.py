...
from gestor_biblioteca_casa.bootstrap import SQL_SCRIPT, CURRENT_VERSION
...
def test_add_persist_in_sqlite_db_and_list_returns_in_memory_books(repo):
    ...
    book1 = Book(id= fake_id1, title='titulo1', author='autor1')
    book2 = Book(id= fake_id2, title='titulo2', author='autor2')
    book3 = Book(id= fake_id3, title='titulo3', author='autor3')
